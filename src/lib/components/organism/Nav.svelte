...
<nav class="sticky top-4 z-9 flex justify-center sm:justify-between lg:top-6 xl:top-8">
	<section class="z-1 rounded-2xl border border-main-sm bg-bg px-2 shadow-lg shadow-bg">
	...
	<section
		class="fixed right-4 bottom-4 z-1 flex flex-col gap-2 rounded-2xl border border-main-sm bg-bg p-2 shadow-lg shadow-bg sm:static sm:flex-row"
	>
		<ThemeSelector />
		<Button icon="share" />
	</section>
	<div
		class="absolute bottom-0 z-0 h-[calc(100%+1rem)] w-full bg-linear-0 from-transparent to-bg lg:h-[calc(100%+1.5rem)] xl:h-[calc(100%+2rem)]"
	></div>
</nav>
